...
public final class ReportManager {
     ...
     * @param dbre The database that testCase will run on.
     */
     ...
     * 
     * @param testCase The testcase that was run.
     * @param result The result of the test case.
     * @param dbre The database which the test case was run on.
     */
    ...
    //  ---------------------------------------------------------------------
    /**
     * Count how many databases passed a particular test. A test is considered to have passed if
     * there are no reports of level ReportLine.PROBLEM.
     * 
    ...
    /**
     * Count how many tests passed and failed. A test is considered to have passed if there are no
     * reports of level ReportLine.PROBLEM.
     * 
     ...
     * @param test The test case to filter by.
