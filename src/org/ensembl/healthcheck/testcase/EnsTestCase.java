...
public abstract class EnsTestCase {
  ...
  public Connection importSchema(String fileName) {
    ...
    try {
      ...
      Connection tmp_con = DriverManager.getConnection(dbProps.getProperty("databaseURL"), dbProps.getProperty("user"), dbProps.getProperty("password"));
      ...
      tmp_con.close();
      con = DriverManager.getConnection(dbProps.getProperty("databaseURL") + tempDBName, dbProps.getProperty("user"), dbProps.getProperty("password"));
