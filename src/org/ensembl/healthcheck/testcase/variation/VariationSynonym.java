...
/**
 * Check for duplicate synonym names which may have different import sources
 * despite having the same original source
 */
	...
	public boolean run(DatabaseRegistryEntry dbre) {
		...
		try {
			...
			int rows = DBUtils.getRowCount(con,
					"select vs1.variation_synonym_id, vs1.variation_id, vs1.name from variation_synonym vs1, variation_synonym vs2 where  vs2.variation_id =  vs1.variation_id and vs2.name  = vs1.name and vs2.variation_synonym_id > vs1.variation_synonym_id and vs1.source_id = vs2.source_id");
