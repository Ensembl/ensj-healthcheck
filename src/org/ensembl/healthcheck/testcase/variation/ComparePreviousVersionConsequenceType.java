...
/**
 * Compare the number of transcript_variation alleles having each consequence 
 * type between the current database and the database on the secondary server.
 */
...
public class ComparePreviousVersionConsequenceType extends ComparePreviousVersionBase {
	...
	protected Map getCounts(DatabaseRegistryEntry dbre) {
		...
		new String("TranscriptVariation"),
		new String("RegulatoryRegionVariation")
	    };
