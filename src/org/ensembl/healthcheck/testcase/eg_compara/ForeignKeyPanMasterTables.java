...
public class ForeignKeyPanMasterTables extends AbstractComparaTestCase {

	public ForeignKeyPanMasterTables() {
		setDescription("Check for broken foreign-key relationships in the Pan compara master tables.");
