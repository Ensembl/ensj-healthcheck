/*
VersionedGenes.javaVersionedGenes.java * Copyright [1999-2015] Wellcome Trust Sanger Institute and the EMBL-European Bioinformatics Institute
 ...
 * 
 */
public class VersionedTranslations extends AbstractRowCountTestCase {

	public VersionedTranslations() {
	...
	protected String getSql() {
            return "select count(*) from translation where version is not null";
	}
	...
	protected String getErrorMessage(int count) {
		return "Found " + count
				+ " genes with non-null translations - these should be nullified";
	}
