 ...
 * 
 */
public class VersionedGenes extends AbstractRowCountTestCase {

	public VersionedGenes() {
	...
	protected String getSql() {
            return "select count(*) from gene where version is not null";
	}
	...
	protected String getErrorMessage(int count) {
		return "Found " + count
				+ " genes with non-null versions - these should be nullified";
	}
