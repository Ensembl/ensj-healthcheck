 ...
 * 
 */
public class VersionedTranscripts extends AbstractRowCountTestCase {

	public VersionedTranscripts() {
	...
	protected String getSql() {
            return "select count(*) from transcript where version is not null";
	}
	...
	protected String getErrorMessage(int count) {
		return "Found " + count
				+ " transcripts with non-null versions - these should be nullified";
	}
