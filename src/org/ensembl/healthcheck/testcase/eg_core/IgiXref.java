...
public class IgiXref extends AbstractEgCoreTestCase {
	...
	/* (non-Javadoc)
	 * @see org.ensembl.healthcheck.testcase.eg_core.AbstractEgCoreTestCase#runTest(org.ensembl.healthcheck.DatabaseRegistryEntry)
	 */
	@Override
	protected boolean runTest(DatabaseRegistryEntry dbre) {
		boolean passes = true;
		int n = getTemplate(dbre).queryForDefaultObject("Select count(*) from xref where external_db_id=60014",Integer.class);
		if(n>0) {
