...
public class ComparaForeignKeyTestCaseHomologyId extends EnsTestCase {
  
  /**
   * Create an OrphanTestCase that applies to a specific set of databases.
   */
  public ComparaForeignKeyTestCaseHomologyId() {
  ...
  public TestResult run() {
    ...
    while (it.hasNext()) {
      ...
      if( getRowCount( con, "select count(*) from homology" ) > 0 ) {
