 ...
 */
public class StableID extends EnsTestCase {
	...
	public boolean checkStableIDs(Connection con, String typeName) {
		...
		String nInvalidVersionsStr =
			getRowColumnValue(
				con,
				"select count(*) as " + typeName + "_with_invalid_version" + " from " + typeName + "_stable_id where version<1;");
