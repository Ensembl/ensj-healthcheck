...
public class ForeignKeyMethodLinkSpeciesSetId extends SingleDatabaseTestCase {
    ...
    public boolean run(DatabaseRegistryEntry dbre) {
        ...
        if (tableHasRows(con, "method_link_species_set_id")) {

            result &= checkForOrphans(con, "method_link_species_set", "method_link_species_set_id", "homology", "method_link_species_set_id");
            result &= checkForOrphans(con, "homology", "method_link_species_set_id", "method_link_species_set", "method_link_species_set_id");
            result &= checkForOrphans(con, "method_link_species_set", "method_link_species_set_id", "family", "method_link_species_set_id");
            result &= checkForOrphans(con, "family", "method_link_species_set_id", "method_link_species_set", "method_link_species_set_id");
 
            //            result &= checkForOrphans(con, "method_link_species_set", "method_link_species_set_id", "genomic_align_block", "method_link_species_set_id");
            ...
            //            result &= checkForOrphans(con, "method_link_species_set", "method_link_species_set_id", "genomic_align", "method_link_species_set_id");
