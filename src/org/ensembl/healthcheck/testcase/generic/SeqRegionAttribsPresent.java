	...
	public boolean run(final DatabaseRegistryEntry dbre) {
		...
		for (int i = 0; i < attribCodes.length; i++) {
			...
			if (count == 0) {
				...
				ReportManager.problem(this, con, "No seq_region_attribs of code " + code + " - there should be some. This may indicate that the seq_region_attribs.pl script needs to be run.");
				result = false;
