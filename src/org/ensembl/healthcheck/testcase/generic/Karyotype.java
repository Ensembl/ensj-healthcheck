...
public class Karyotype extends SingleDatabaseTestCase {
	...
	public boolean run(DatabaseRegistryEntry dbre) {
        ...
        protected boolean karyotypeExists(DatabaseRegistryEntry dbre) {
                ...
                String sqlMT = "SELECT count(*) FROM seq_region_attrib sa, attrib_type at, seq_region s WHERE s.seq_region_id = sa.seq_region_id AND at.attrib_type_id = sa.attrib_type_id AND code = 'karyotype_rank' AND s.name = 'MT'";
