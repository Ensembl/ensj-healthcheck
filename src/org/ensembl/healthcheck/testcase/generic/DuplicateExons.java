...
public class DuplicateExons extends SingleDatabaseTestCase {
	...
	public boolean run(DatabaseRegistryEntry dbre) {
		...
		String sql =
			"SELECT e.exon_id, e.phase, e.seq_region_start AS start, e.seq_region_end AS end, e.seq_region_id AS chromosome_id, e.end_phase, e.seq_region_strand AS strand "
