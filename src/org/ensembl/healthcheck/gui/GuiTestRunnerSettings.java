...
public class GuiTestRunnerSettings extends JDialog {
	...
	private void initComponents() {
		...
		outputComboBox.setModel(new DefaultComboBoxModel(new String[] { "All", "Problems only", "Correct results", "Summary", "Info", "None" }));
		...
		applyButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				levels.put("All", ReportLine.ALL);
				levels.put("Problems only", ReportLine.PROBLEM);
				levels.put("Correct results", ReportLine.CORRECT);
				levels.put("Warnings", ReportLine.WARNING);
				levels.put("Info", ReportLine.INFO);
				levels.put("None", ReportLine.NONE);
