...
public enum Species {
	...
	SARCOPHILUS_HARRISII(9305, "devil", "ENSSHA", "devil,Sarcophilus_harrisii,sarcophilus_harrisii,tasmanian_devil,taz"), AILUROPODA_MELANOLEUCA(9646, "ailMel1", "ENSAME",
			...
			"wallaby,tammar_wallaby,macropuseugenii,m_eugenii,tammarwallaby,Macropus eugenii,macropus_eugenii"), CALLITHRIX_JACCHUS(9483, "calJac", "ENSCJA",
			...
			"squirrel,stridecemlineatus,thirteen-lined_ground_squirrel,spermophilus_tridecemlineatus_arenicola,spermophilus_tridecemlineatus"), SUS_SCROFA(9823, "PIG", "ENSSSC",
