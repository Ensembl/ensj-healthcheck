...
public class DatabaseConnectionIteratorTest extends TestCase {
    ...
    public void setUp() {
        ...
        dbci = new DatabaseConnectionIterator("org.gjt.mm.mysql.Driver", "jdbc:mysql://kaka.sanger.ac.uk/",
                "anonymous", "", dbNames);
    }

    /**
     * Test of hasNext method, of class
     * org.ensembl.healthcheck.util.DatabaseConnectionIterator.
     */
    ...
    /**
     * Test of getCurrentDatabaseName method, of class
     * org.ensembl.healthcheck.util.DatabaseConnectionIterator.
     */
