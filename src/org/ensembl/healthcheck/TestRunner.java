...
public class TestRunner {
	 ...
	 * the test implements the Repair interface and the appropriate flags are set.
	 * 
	 ...
	 * 
	 * @param level
	 *          The lowest report level (see ReportLine) to print. Reports with a
	 *          level lower than this are not printed.
