...
/**
 * These are the tests required for a staging database after compara handover. The tests are:
 * 
 * <ul>
 ...
 *
 */
public class PostComparaHandover extends GroupOfTests {

        public PostComparaHandover() {
